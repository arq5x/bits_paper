...
potential that MC-BITS has for large-scale data mining experiments, 
...
Using MC-BITS, we compared the observed and expected number
of intersections for each of the 25,921 pairwise (i.e., 161*161)
